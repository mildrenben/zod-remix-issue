...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create zod-remix-issue-87c4
  fly apps create zod-remix-issue-87c4-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app zod-remix-issue-87c4
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app zod-remix-issue-87c4-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'zod-remix-issue-87c4-staging' does not match app name in config file 'zod-remix-issue-87c4'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name zod-remix-issue-87c4-db
  fly postgres attach --app zod-remix-issue-87c4 zod-remix-issue-87c4-db

  fly postgres create --name zod-remix-issue-87c4-staging-db
  fly postgres attach --app zod-remix-issue-87c4-staging zod-remix-issue-87c4-staging-db
  ```
